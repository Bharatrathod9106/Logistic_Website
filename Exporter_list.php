        ...
        <table id="customers" align="center">
            ...
            ?> 
                    <tr>
                        ...
                        <td><a href="exporter_update.php?id=<?php echo $rows['id'];?>"><img src="icon/updated.png"></a></td>
                        <td><a href="exporter_delete.php?id=<?php echo $rows['id'];?>"><img src="icon/delete.png"></a></td>
                    </tr>
            <?php 
                }
            ?>
