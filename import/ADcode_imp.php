            ...
            <form action="" method="post">
                ...
                <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter branch no" required name="branch">
                    </div>

                    <div class="input-box">
                        <span class="detail" id="padd3">Bank Code</span>
                        <input type="text" placeholder="Enter Bank code" required name="bankcode">
                    </div>

                    <div class="input-box">
                        <span class="detail" id="padd4">AC NO</span>
                        <input type="text" placeholder="Enter AC no" required name="acno">
                    </div>

                    <div class="input-box">
                        <span class="detail" id="padd5">Bank Name </span>
                        <input type="text" placeholder="Enter Bank Name" required name="bankname">
                    </div>

                    <div class="input-box">
                        <span class="detail" id="padd6">Add-1</span>
                        <input type="text" placeholder="Enter Address-1" required name="add1">
                    </div>
                    
                    <div class="input-box">
                        <span class="detail" id="padd7">Add-2</span>
                        <input type="text" placeholder="Enter Address-2" required name="add2">
                    </div>

                    <div class="input-box">
                        <span class="detail" id="padd8">Pin code</span>
                        <input type="text" placeholder="Enter Bank code" required name="pincode">
                    </div>
